...
This MVP accepts a public URL plus optional caption/transcript text and returns:
...
- Modular scoring pipeline with optional external deepfake API integration
...
2. Replace heuristic claim checks with RAG-based evidence retrieval and LLM verification.
